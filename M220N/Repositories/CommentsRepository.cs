...
namespace M220N.Repositories
{
    public class CommentsRepository
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            Builders<Comment>.Filter.Where(c=> c.Id == commentId && c.Name == user.Name),
            ...
            */
            try
            {
                ...
                result = await _commentsCollection
                  ...
                  .Aggregate()
                  .Group(c => c.Email, g => new ReportProjection { Id = g.Key, Count = g.Count()})
                  .SortByDescending(g => g.Count)
                  .Limit(20)
                  .Project<ReportProjection>(Builders<ReportProjection>.Projection.Include("Id").Include("Count")).ToListAsync();
