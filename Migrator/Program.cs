...
namespace Migrator
{
    ...
    class Program
    {
        ...
        static string mongoConnectionString = "mongodb+srv://m220student:m220password@mflix.otq9b.mongodb.net/myFirstDatabase?retryWrites=true&w=majority";
        ...
        static async Task Main(string[] args)
        {
            ...
            if (datePipelineResults.Count > 0)
            {
                ...
                {
                    var request = new ReplaceOneModel<Movie>(new FilterDefinitionBuilder<Movie>().Where(m => m.Id == item.Id), item);
